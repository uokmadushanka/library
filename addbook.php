                ...
                <div class="card-body">
                    ...
                    <form method="post"   onsubmit="return validateForm()">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" id="book_id" name="book_id" placeholder="Input Book ID(eg.B001)" autocomplete="off">
                        </div>
                        <div class="form-group mt-4">
                            <label for="book_name">Book Name</label>
                            <input type="text" class="form-control mt-2" id="book_name" name="book_name" placeholder="Input Book Name" autocomplete="off">
                        </div>
                        <div class="form-group mt-4">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-secondary me-2 mt-4" name="submit" id="submit">Add Book</button>
                            <button type="button" class="btn btn-info  mt-4" onclick="closeForm()">Close</button>
                        </div>                                               
                    </form>
                </div>
            </div>
